...
class Result extends React.Component {
    constructor() {
        super()
        this.fieldVariables = { examinationType: '', subjectResultArray: [] }
        ...
        data.forEach(subjectObj => {
            subjectOptions6to12.forEach(obj => {
                if (subjectObj === obj.value) {
                    subjects.push({ subjectName: obj.label, totalMarks: null, obtainMarks: null, grade: '' })
                }
            })
        })
    ...
    handleClose = () => {
        if (this.props.match.params.aeReportId) {
