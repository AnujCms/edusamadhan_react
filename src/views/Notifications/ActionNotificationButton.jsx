    ...
    render() {
        ...
        return (
            <div className={classes.root}>
                ...
                >
                    <MenuItem onClick={this.handleEditNotification} className={classes.borderBottom + " " + classes.liCommon}><EditIcon className={classes.btnIcon} />Edit Notification</MenuItem>
                    <MenuItem onClick={this.handleDeleteNotification} className={classes.borderBottom + " " + classes.liCommon}><DeleteIcon className={classes.btnIcon} />Delete Notification</MenuItem>
                </Menu>
            </div>
        )
    }
