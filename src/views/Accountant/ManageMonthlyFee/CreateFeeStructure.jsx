...
class CreateFeeStructure extends React.Component {
    ...
    async componentDidMount() {
        ...
        if (classs) {
            let response = await this.props.authenticatedApiCall('get', '/api/studentfeeservice/getfeedetailbyclass/'+ classs + '/'+mediumType, null);
            if (response.data.status === 1) {
    ...
    render() {
        ...
        return (
            <div className={classes.root}>
                ...
                <Formik initialValues={{ class: '', mediumType:'', january: '', february: '', march: '', april: '', may: '', june: '', july: '', august: '', september: '', october: '', november: '', december: '' }} onSubmit={this.handleSubmit} validationSchema={this.yupSchema}>
                    {(props) => (
                        <>
                            <Form>
