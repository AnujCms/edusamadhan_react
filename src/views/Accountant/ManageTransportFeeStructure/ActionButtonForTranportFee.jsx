    ...
    render() {
        ...
        return (
            <div className={classes.root}>
                ...
                >
                    <MenuItem onClick={this.handleEditTransportFee} className={classes.borderBottom + " " + classes.liCommon}><Edit className={classes.btnIcon} />Edit</MenuItem>
                    <MenuItem onClick={this.handleDeleteTransportFee} className={classes.borderBottom + " " + classes.liCommon}><Delete className={classes.btnIcon} />Delete</MenuItem>
                </Menu>
            </div>
        )
    }
