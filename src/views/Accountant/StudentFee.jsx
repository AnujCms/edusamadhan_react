...
import PayFee from './PayAdharCard';
...
class StudentFee extends React.Component {
    ...
    handleSubmit = async () => {
        ...
        let url = '/api/studentfeeservice/feedetails/'+ this.state.adharnumber ;
        ...
        if (response.data.status === 1) {
            ...
            this.setState({startSpinner:false,isError:true, errorMessage:"Student is not registered with this AAdhar number."})
        }
    }
    ...
    render() {
        ...
        return (
            <div className={classes.root}>
                ...
                {this.state.submited ? <Card className={classes.cardRoot}>
                {this.state.startSpinner&&<Spinner style={{ position: "absolute", top: "30%", left: "45%", zIndex:'99999' }}/>}
                    <ValidatorForm onSubmit={this.handleSubmit}>
                        <CardContent>
                            <Typography variant="h5">Search Student Fee details</Typography>
                            <div className={classes.questionContainer}>
                                <TextValidator
                                    ...
                                    errorMessages={['Student AAdhar Number is required','Enter valid 12 digit AAdhar number','Enter valid 12 digit AAdhar number']}
                                />
                            </div>
                        </CardContent>
                        <Grid container>
                            <Grid item>
                                <CardActions className={classes.pad_15}>
                                    <Button type="submit" disabled={this.state.startSpinner} className={classes.primaryButton}>Search</Button>
                                </CardActions>
                            </Grid>
                        </Grid>
                    </ValidatorForm>
                    ...
                    <Grid container className={classes.GridContainer}>
                        <Grid item lg={5} md={5} sm={12} xs={12}>
                            ...
                            <ValidatorForm onSubmit={this.handleClick}>
                                <Card>
                                    <CardContent>
                                        {this.state.payfee ? <div>{this.props.adharnumber ? <PayFee adharnumber={this.props.adharnumber} busservice={this.state.busservice} transportFee={this.state.transportFee}/> : <PayFee adharnumber={this.state.adharnumber} busservice={this.state.busservice} transportFee={this.state.transportFee}/>}</div> :
                                            <Grid container>
                                                <Grid item>
                                                    <CardActions className={classes.pad_15}>
                                ...
                                <CardContent>
                                    <Table>
                                        <TableHead>
                                            ...
                                            <TableRow>
                                                <TableCell className={classes.tableHeading}><b>Month Namee</b></TableCell>
...
export default withStyles(styles)(AuthenticatedPage(["FeeAccount"])(StudentFee));
