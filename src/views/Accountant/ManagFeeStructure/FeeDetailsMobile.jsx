...
class FeeDetailsMobile extends React.PureComponent {
    ...
    getBodyComponent = (feeStructure) => {
        let mediumType = 1;
        if(feeStructure.mediumType == "English"){
            mediumType = 2
        }
        ...
        if (activeComponent === "allmonthfee") {
            ...
            return <CreateFeeStructure feeStructureId={feeStructure.feeStructureId} mediumType={mediumType} />
        }
    ...
    render() {
        ...
        return (
            <>
                ...
                {this.getBodyComponent(feeDetails)}
...
export default withStyles(styles)(AuthenticatedPage()(FeeDetailsMobile));