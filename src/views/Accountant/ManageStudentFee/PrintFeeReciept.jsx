...
import { withStyles, Card, CardContent, Typography, Grid, Table, TableBody, TableCell, TableRow } from '@material-ui/core';
...
class PrintFeeReciept extends React.Component {
    ...
    async componentDidMount() {
        ...
        let res = await this.props.authenticatedApiCall('get', '/api/accountantservice/getfeeprintdetails/' + studentId, null);
        ...
        let url = '/api/accountantservice/feedetails/' + studentId;
...
export default withStyles(styles)(AuthenticatedPage()(PrintFeeReciept));