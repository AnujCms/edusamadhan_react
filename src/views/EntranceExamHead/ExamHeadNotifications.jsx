...
class ExamHeadNotifications extends React.Component {
    state = {
    ...
    render() {
        ...
        return (
            <div className={classes.root}>
                <Helmet> <title>Notiifcations List</title></Helmet>
...
export default withStyles(styles)(AuthenticatedPage("ExamHead")(WithAccount(ExamHeadNotifications)));