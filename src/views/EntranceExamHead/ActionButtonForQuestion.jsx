    ...
    render() {
        ...
        return (
            <div className={classes.root}>
                ...
                >
                    <MenuItem onClick={this.handleEditQuestion} className={classes.borderBottom+" "+classes.liCommon}><EditIcon className={classes.btnIcon}/>Edit</MenuItem>
                    <MenuItem onClick={this.handleDeleteQuestion} className={classes.borderBottom+" "+classes.liCommon}><DeleteIcon className={classes.btnIcon}/>Delete</MenuItem>
                </Menu>
            </div>
        )
    }
