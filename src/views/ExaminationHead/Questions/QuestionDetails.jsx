...
class QuestionDetails extends React.PureComponent {
    ...
    handleDelete = async () => {
        let response1 = await this.props.authenticatedApiCall('delete', "/api/examinationservice/deleteQuestion/" + this.props.location.state.questionId, null)
        ...
        return (
            <>
                <div>
                    ...
                    {this.getBodyComponent(questionDetails.questionId)}
...
export default withStyles(styles)(AuthenticatedPage()(QuestionDetails));