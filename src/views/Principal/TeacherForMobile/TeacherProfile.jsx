                        ...
                        <GridItem xs={12} sm={12} >
                            <Table>
                                <TableBody>
                                    ...
                                    <TableRow>
                                        <TableCell className={classes.tableHeading}> AAdhar Number  </TableCell>
                                        <TableCell className={classes.tableHeading}> {teacherDetails.aadharNumber} </TableCell>
                                    </TableRow>
                                    <TableRow>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell className={classes.tableHeading}> {teacherDetails.classId} </TableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
                        </GridItem>
