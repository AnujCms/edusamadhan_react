...
import { entranceExamOptions, subjectOptions, qualificationOptions, userRoleOption, educationalAwards, workExperienceOptions } from '../../../components/utilsFunctions';
    ...
    render() {
        ...
        return (
            <>
                ...
                <Card className={classes.backgroundColor}>
                    <Grid container className={classes.questionContainer}>
                        <SelectWithLabel fieldLabel={'Select User Role'} fieldName={'userrole'} selectOptions={userRoleOption} />
                ...
                <Card className={classes.backgroundColor}>
                    <Grid container className={classes.questionContainer}>
                        ...
                        {(this.props.formik.values.userrole.value == 6) && <SelectWithLabel fieldLabel={'Exam Type'} fieldName={'entranceExamType'} selectOptions={entranceExamOptions} />}
