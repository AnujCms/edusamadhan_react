    ...
    render() {
        ...
        return (
            <div className={classes.root}>
                ...
                >
                    <MenuItem onClick={this.handleEditAccountanat} className={classes.borderBottom+" "+classes.liCommon}><Edit className={classes.btnIcon}/>Edit Accountant</MenuItem>
                    ...
                    {this.props.status == 1 && <MenuItem onClick={this.handleInactivateUser} className={classes.borderBottom+" "+classes.liCommon}><Lock className={classes.btnIcon}/>Inactivate Accountant</MenuItem>}
                    {this.props.status == 2 && <MenuItem onClick={this.handleReactivateUser} className={classes.borderBottom+" "+classes.liCommon}><LockOpen className={classes.btnIcon}/>Reactivate Accountant</MenuItem>}  
                    {this.props.status == 4 && <MenuItem onClick={this.handleUnlockUser} className={classes.borderBottom+" "+classes.liCommon}><LockOpen className={classes.btnIcon}/>Unlock Accountant</MenuItem>}                                                                                                                                                                                                    
                    <MenuItem onClick={this.handleDeleteUser} className={classes.borderBottom+" "+classes.liCommon}><Delete className={classes.btnIcon}/>Delete Accountant</MenuItem>
                </Menu>
            </div>
        )
    }
