            ...
            <>
                ...
                <Card className={classes.actions} >
                    <GridContainer style={{ justifyContent: "space-around" }}>
                        ...
                        <GridItem sm={3} xs={3} className={classes.texeCenter}><Button onClick={this.handleStudentsList} className={this.state.activeComponent === "studentslist" ? classes.addColor : null}><FontAwesomeIcon icon={faDatabase} className={classes.iconSize} /></Button></GridItem>
                    </GridContainer>
                </Card>
            </>
        )
...
export default withStyles(styles)(AuthenticatedPage(["Teacher"])(TeacherDetails));