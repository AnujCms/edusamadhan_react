...
class EventsListForStudent extends React.Component {
    state = {
            ...
            <div className={classes.root}>
                <Grid container className={classes.GridContainer}>
                    ...
                    <Grid item lg={12} md={12} sm={12} xs={12} style={{ marginBottom: '50px' }}>
                        <MuiThemeDataTable title={'Events Lists'} rows={this.state.students} columns={this.tableheads1} rowDetailsRedirectFunction={this.displayStudentDetailsForMobileView} tableContent="studentsList" />
                    </Grid>
                </Grid>
...
export default withStyles(styles)(AuthenticatedPage("Student")(WithAccount(EventsListForStudent)));