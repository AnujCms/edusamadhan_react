...
class EventsList extends React.Component {
    state = {
        successMessage: '', isSuccess: false, isDeleteEvent: false, students: [], eventid: '', errorMessage: '', isError: false
    };
...
export default withStyles(styles)(AuthenticatedPage("Principal")(WithAccount(EventsList)));