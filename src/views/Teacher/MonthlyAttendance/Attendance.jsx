        ...
        if (response.data.status == 1) {
            ...
            if (getdailyattendance.data.status == 1) {
                getdailyattendance.data.statusDescription.map((item, index) => {
                    if(response.data.statusDescription[index] != undefined){
                        item.name = response.data.statusDescription[index].firstname + " " + response.data.statusDescription[index].lastname
                        item.images = response.data.statusDescription[index].images    
                    }
