    ...
    render() {
        ...
        return (
            <div className={classes.root}>
                ...
                >
                    <MenuItem onClick={this.handleEditEvent} className={classes.borderBottom + " " + classes.liCommon} disabled><EditIcon className={classes.btnIcon} />Edit Event</MenuItem>
                    <MenuItem onClick={this.handleDeleteEvent} className={classes.borderBottom + " " + classes.liCommon} disabled><LockIcon className={classes.btnIcon} />Delete Event</MenuItem>
                </Menu>
            </div>
        )
    }
