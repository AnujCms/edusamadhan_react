...
const styles = theme => ({
    ...
    headPopAdmin: { padding: "20px 15px",float: "left", color:"#001C61", '&:hover':{background:"transparent",color:"#06303f"},fontWeight: "300",lineHeight: "1.7","& span":{fontSize:"14px !important"}},
    drpDownIcnStyle:{marginLeft:"6px", fontSize: '14px', color: "rgb(170, 173, 175)"},
    drpDownIcnStyleAdmin:{marginLeft:"6px", fontSize: '14px', color: "#001C61"},
    elevationPopover:{zIndex:"10002 !important"}
});

class ClassWorkDropdown extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <div>
                ...
                >Class Work<FontAwesomeIcon icon={faChevronDown} className={classes.drpDownIcnStyleAdmin} />
                </Button>
                ...
                >
                    <div className={classes.simpleMenu}>
                        <MenuItem onClick={this.handlepopClose}><NavLink to={`${match.url}/homework`} className={classes.navLink} activeStyle={{ fontWeight: "bold", color: this.props.color }} style={{ padding: "0", width: "100%", color: '#515974',alignItems: "center",fontSize: "16px" }} ><img src={clipboard} className={classes.navchildlogo} />Home Work</NavLink></MenuItem>
                        <MenuItem onClick={this.handlepopClose}><NavLink to={`${match.url}/offlineadmission`} className={classes.navLink} activeStyle={{ fontWeight: "bold", color: this.props.color }} style={{ padding: "0", width: "100%", color: '#515974',alignItems: "center",fontSize: "16px" }} ><img src={clipboard} className={classes.navchildlogo} />Assisment</NavLink></MenuItem>
...
export default withStyles(styles)(ClassWorkDropdown);