...
class NotificationDetails extends React.PureComponent {
    ...
    handleBackNotificationList = () => {
        this.setState({ activeComponent: "backtonotifications" })
    }
    ...
    getBodyComponent = (notificationid) => {
        ...
        }else if (activeComponent === "backtonotifications") {
            ...
            <>
                ...
                <Card className={classes.actions} >
                    <GridContainer style={{ justifyContent: "space-around" }}>
                        <GridItem sm={2} xs={2} className={classes.texeCenter}><Button onClick={this.handleBackNotificationList} className={this.state.activeComponent === "backtoevents" ? classes.addColor : null}><FontAwesomeIcon icon={faFastBackward} className={classes.iconSize} /></Button></GridItem>
                        ...
                        <GridItem sm={2} xs={2} className={classes.texeCenter}><Button disabled={notificationDetails.createdby === 'Principal' || this.state.activeComponent === 'createNotification'} onClick={this.handleUpdateNotification} className={this.state.activeComponent === "updatenotification" ? classes.addColor : null}><FontAwesomeIcon icon={faUserEdit} className={classes.iconSize} /></Button></GridItem>
                        <GridItem sm={2} xs={2} className={classes.texeCenter}><Button disabled={notificationDetails.createdby === 'Principal' || this.state.activeComponent === 'updatenotification'} onClick={this.handleCreateNotification} className={this.state.activeComponent === "createNotification" ? classes.addColor : null}><FontAwesomeIcon icon={faPlusCircle} className={classes.iconSize} /></Button></GridItem>
                        <GridItem sm={3} xs={3} className={classes.texeCenter}><Button disabled={notificationDetails.createdby === 'Principal' || this.state.activeComponent === 'updatenotification' || this.state.activeComponent === 'createNotification'} onClick={this.handleDeleteNotification} className={this.state.activeComponent === "deleteNotification" ? classes.addColor : null}><FontAwesomeIcon icon={faTrash} className={classes.iconSize} /></Button></GridItem>
                    </GridContainer>
...
export default withStyles(styles)(AuthenticatedPage(["Teacher"])(NotificationDetails));