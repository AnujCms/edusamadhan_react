    ...
    return object().shape({
        ...
        subjectResultArray : array().of(
            object().shape({
                ...
                theoryObtainMarks: number().positive().typeError('This field is required').lessThan(ref('theoryTotalMarks'),'Obtained marks can not be greater than Total Marks').required("This field is required").min(0, "Obtain Marks can not be less than 0."),
                ...
                practicalObtainMarks: number().positive().typeError('This field is required').lessThan(ref('practicalTotalMarks'),'Obtained marks can not be greater than Total Marks').required("This field is required").min(0, "Obtain Marks can not be less than 0."),
