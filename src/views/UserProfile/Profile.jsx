                                ...
                                <Table>
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell className={classes.tableCell}>{classs} {section}</TableCell>
                                        </TableRow>
                                    </TableBody>
                                </Table>
                            </CardContent>
...
export default withStyles(styles, { withTheme: true })(AuthenticatedPage(["Teacher", "AccountAdmin", "DefaultAccountAdmin", "ExamHead"])(connect(TeacherProfile)));
