...
class FeeAccountNotifications extends React.Component {
    state = {
...
export default withStyles(styles)(AuthenticatedPage("FeeAccount")(WithAccount(FeeAccountNotifications)));