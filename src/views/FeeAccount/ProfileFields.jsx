...
class ProfileFields extends Component {
    ...
    componentDidMount = async () => {
        this.props.formik.setFieldValue('file', this.props.image, false);
    }
...
export default withWidth()(withStyles(styles, { withTheme: true })(AuthenticatedPage(["FeeAccount"])(connect(ProfileFields))));
