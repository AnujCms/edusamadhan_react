...
class FeeAccountProfile extends Component {
    state = {
       image:'', isRender:false, firstname: "", lastname: "", cellnumber: "", emailid: "", dob: "", parmanentaddress: "", localaddress: "", classs: "", section: "",
                        ...
                        <Card>
                            <CardContent>
                                <Table>
                                    <TableBody>
                                        <TableRow>
                                            <TableCell colSpan="2" className={classes.tableHeading}> <h3>Teacher Details</h3> </TableCell>
                                        </TableRow>
                                        <TableRow>
...
export default withStyles(styles, { withTheme: true })(AuthenticatedPage(["FeeAccount"])(connect(FeeAccountProfile)));
